/*
 * Conexión básica por MQTT del ESPCAM32
 * por: Hugo Escalpelo
 * Fecha: 28 de julio de 2021
 * Actualizado por: Joshua Nava
...
//Datos de WiFi
const char* ssid = "NavaIbarra";  // Aquí debes poner el nombre de tu red
const char* password = "Josh220101Nava";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "192.168.1.67"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
